...
@Component({
    ...
    templateUrl: 'event_select.html'
})
export class Event_select {
    ...
    constructor(public navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController,
        public classprovider: ClassProvider, public loadingController: LoadingController, public globalVars: GlobalVars) {
